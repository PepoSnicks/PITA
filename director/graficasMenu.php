...
$sql = "SELECT periodo FROM periodos WHERE activo = 1";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
    $row = $result->fetch_assoc();
    $periodo_activo = $row['periodo'];
} else {
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-md-4 col-lg-4 mb-2 mb-md-3">
                <button class="btn btn-dark btn-custom d-flex flex-column justify-content-center align-items-center" onclick="window.location.href='./graficasEncuestas.php'"><i class="bi bi-card-checklist"></i><span>Gráficas encuestas de satisfacción</span></button>
            </div>
            <div class="col-12 col-md-4 col-lg-4 mb-2 mb-md-3">
                <button class="btn btn-dark btn-custom d-flex flex-column justify-content-center align-items-center" onclick="window.location.href='./graficasCitas.php'"><i class="bi bi-calendar-event"></i><span>Gráficas de las citas</span></button>
            </div>
            <div class="col-12 col-md-4 col-lg-4 mb-2 mb-md-3">
                <button class="btn btn-dark btn-custom d-flex flex-column justify-content-center align-items-center" onclick="window.location.href='./graficasProblemas.php'"><i class="bi bi-exclamation-triangle"></i><span>Gráficas de los problemas</span></button>
            </div>
        </div>
    </div>
</body>
