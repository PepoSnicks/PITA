...
<header>
    ...
    <div class="container">
        <div class="row justify-content-center mt-3 text-center">
            <div class="col-12">
            <button type="button" class="btn btn-vino" data-toggle="modal" data-target="#sendMessageModal" style="background-color: #8B1D35; color: white;">
    Enviar mensaje
</button>
            </div>
        </div>
                ...
                <div class="list-group">
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<img src='{$imagenPerfilRemitente}' alt='' class='mr-3' style='width: 40px; height: 40px; border-radius: 50%;'>";
                            echo "<div>";
...
<div class="modal fade" id="sendMessageModal" tabindex="-1" role="dialog" aria-labelledby="sendMessageModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
            <h5 class="modal-title" style="color: #000;" id="sendMessageModalLabel">Enviar mensaje</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="./php/enviarMensaje.php" method="POST">
                <div class="modal-body text-dark-theme">
                    <div class="row">
                        <div class="col-md-9">
                            <div class="form-group">
                            <label for="profesorName" style="color: #000">Nombre del profesor receptor</label>
                        ...
                        <div class="col-md-3 d-flex align-items-center">
                            <img id="profesorImagen" src="/imagenes/default.jpg" alt="" style="width: 70px; height: 70px;">
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="messageText" style="color: #000">Mensaje</label>
                        <textarea class="form-control" id="messageText" name="messageText" rows="10" required></textarea>
                    </div>
                </div>
                <div class="modal-footer">
    <button type="submit" class="btn btn-success" style="background-color: #8B1D35;" name="enviarMensaje">Enviar</button>
    <button type="button" class="btn btn-opciones" style="background-color: #8B1D35; color: white;" data-dismiss="modal">Cancelar</button>
</div>
...
function buscarProfesorPorNombre(nombre) {
    ...
    xhr.open("POST", "php/buscarProfesorPorNombreMensajes.php", true);
