...
<header>
    <nav class="navbar navbar-expand-lg navbar-vino bg-maroon">
            ...
            <img src="./css/NavUPTex.png" alt="Logo" style="width: 200px; height: 50px;">
                ...
                <button id="regresarBtn" class="btn btn-vino mr-2 hover-effect1" onclick="window.location.href='./indexDirector.php'">Regresar</button>
    ...
    <a class="btn btn-vino dropdown-toggle mr-2 hover-effect1 d-flex align-items-center" href="#" id="usuarioDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        ?>
                            ...
                            <div class="dropdown-menu" aria-labelledby="usuarioDropdown">
                                ...
                                <a class="dropdown-item hover-effect1" href="./graficasMenu.php"><i class="bi bi-bar-chart"></i> Gráficas</a>
    ...
    <br>
        <h1 class="text-center" style="color: #fff;"><i class="bi bi-calendar-check-fill" style="color: #088C4F;"></i>  <b>Jefes de carrera</b></h1>
        <br>
        <div class="row">
            ...
            <?php
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo "<button class='btn btn-eliminar-personalizado btn-eliminar' data-nempleado='" . $row["nempleado"] . "'><i class='bi bi-trash-fill'></i></button>";
                                echo "</div></td>";
                                echo "</tr>";
                            }
                        } else {
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-dark" id="editModalLabel">Editar profesor</h5>
            ...
            <div class="modal-body text-dark">
                <form id="editar-profesor-form" method="post">
                    ...
                    <div class="form-group">
                        <label for="nombre-input" class="text-dark">Nombre: </label>
                        <input type="text" class="form-control" id="nombre-input" name="nombre">
                    </div>
                    <div class="form-group">
                        <label for="email-input" class="text-dark">Email: </label>
                        <input type="email" class="form-control" id="email-input" name="email">
                    </div>
                    <div class="form-group">
                        <label for="email-input" class="text-dark">Activo: </label>
                    ...
                    <div class="form-group">
                        <label for="id_nivel-input" class="text-dark">Nivel de acceso: </label>
                    ...
                    <div class="form-group">
                        <label for="nivel-input" class="text-dark">Niveles: </label>
                        <br>
                        <input type="checkbox" id="tutor" name="nivel[]" value="1">
                        <label for="tutor" class="text-dark"> Jefe de carrera</label>
                        <br>
                        <input type="checkbox" id="tutor" name="nivel[]" value="2">
                        <label for="tutor" class="text-dark"> Tutor</label>
                        <br>
                        <input type="checkbox" id="psicologo" name="nivel[]" value="3">
                        <label for="psicologo" class="text-dark"> Psicólogo</label>
                        <br>
                        <input type="checkbox" id="docente" name="nivel[]" value="4">
                        <label for="docente" class="text-dark"> Docente</label>
                    </div>
                    <div class="form-group">
                        <label for="carreras-input" class="text-dark">Carreras: </label>
                        <br>
                        <input type="checkbox" id="isc" name="carreras[]" value="1">
                        <label for="isc" class="text-dark">Ingeniería en sistemas computacionales</label>
                        <br>
                        <input type="checkbox" id="iro" name="carreras[]" value="2">
                        <label for="iro" class="text-dark">Ingeniería en robótica</label>
                        <br>
                        <input type="checkbox" id="iet" name="carreras[]" value="3">
                        <label for="iet" class="text-dark">Ingeniería en electrónica y telecomunicaciones</label>
                        <br>
                        <input type="checkbox" id="ilt" name="carreras[]" value="4">
                        <label for="ilt" class="text-dark">Ingeniería en logística y transporte</label>
                        <br>
                        <input type="checkbox" id="lag" name="carreras[]" value="7">
                        <label for="lag" class="text-dark">Licenciatura en administración y gestión empresarial</label>
                        <br>
                        <input type="checkbox" id="lca" name="carreras[]" value="8">
                        <label for="lca" class="text-dark">Licenciatura en comercio internacional y aduanas</label>
                        <br>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
    <button type="submit" form="editar-profesor-form" class="btn" style="background-color: #800000; color: #ffffff;">Guardar cambios</button>
    <button type="button" class="btn" style="background-color: #800000; color: #ffffff;" data-dismiss="modal">Cerrar</button>
</div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="agregarProfesorModal" tabindex="-1" role="dialog" aria-labelledby="agregarProfesorModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-dark" id="agregarProfesorModalLabel">Agregar profesor</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
                ...
                <form method="POST" action="./php/nuevoProfesor.php" class="text-center">
                    <div class="row">
                        <div class="col-md-12 nivel-container text-center">
                            <div class="form-group">
                                <label for="nivel_acceso" class="text-dark">Tipo de profesor:</label>
                                <br>
                                <input type="checkbox" id="jefe" name="nivel_acceso[]" value="1" checked>
                                <label for="jefe" class="text-dark">Jefe de carrera</label>
                                <br>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 other-fields-container" style="display: none;">
                            ...
                            <div class="form-group">
                                <label for="num_empleado" class="text-dark">Número de empleado:</label>
                            ...
                            <!-- Añadido: Sección para verificar la contraseña del usuario -->
                            <div class="form-group">
                                <label for="contraseña" class="text-dark">Contraseña de usuario:</label>
                    ...
                    <div class="text-left" id="materiasContainer" style="display: none;">
                        <label for="materias" class="text-dark">Materias:</label>
                        <div id="materias" class="materias"></div>
                    </div>
            </div>
            <div class="modal-footer">
    <button type="submit" class="btn" style="background-color: #800000; color: #ffffff;">Agregar profesor</button>
    <button type="button" class="btn" style="background-color: #800000; color: #ffffff;" data-dismiss="modal">Cerrar</button>
</div>
            </form>
        </div>
