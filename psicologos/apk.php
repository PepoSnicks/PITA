...
<body>
    <header>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container">
                <a class="navbar-brand" href="indexPsicologo.php"><img src="./css/logo.png" alt="Logo"></a>
                <div class="d-flex align-items-center">
                    <button id="mensajesBtn" class="btn btn-dark mr-2" onclick="window.location.href='indexPsicologo.php'">Regresar</button>
