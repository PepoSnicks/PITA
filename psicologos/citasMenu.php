...
<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
    ...
    <div class="row justify-content-center mt-3">
        ...
        <button class="btn btn-dark btn-custom citasPropias d-flex flex-column justify-content-center align-items-center mr-2" onclick="window.location.href=\'./citasPropias.php\'"><i class="bi bi-calendar-check"></i><span>Citas psicológicas / académicas</span></button>
        </div>
        <div class="col-12 col-md-4 col-lg-4 mb-2 mb-md-3">
        <button class="btn btn-dark btn-custom citasCanalizar d-flex flex-column justify-content-center align-items-center mr-2" onclick="window.location.href=\'./citasCanalizar.php\'"><i class="bi bi-calendar"></i><span>Citas de tutoría</span></button>
        </div>
        ';
            }
