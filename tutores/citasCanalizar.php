        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-dark btn-personalizado" data-dismiss="modal" style="color: #000;">Cancelar</button>
                    <button type="button" class="btn btn-dark btn-personalizado" id="confirmar-canalizar" style="color: #000;">Canalizar</button>
                </div>
            </div>
        </div>
    </div>
