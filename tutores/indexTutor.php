...
$query_recien_creado = "SELECT recien_creado FROM profesores WHERE nempleado = $usuario";
$result_recien_creado = $conn->query($query_recien_creado);
$recien_creado = $result_recien_creado->fetch_assoc()['recien_creado'];

if ($recien_creado == 1) {
    echo '
    <!-- Código HTML para el modal aquí -->
    <div class="modal fade" id="updatePasswordModal" tabindex="-1" aria-labelledby="updatePasswordModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content text-center">
            <div class="modal-header">
                <h5 class="text-center modal-title" id="updatePasswordModalLabel">Actualizar contraseña</h5>
            </div>
            <div class="modal-body">
            <form method="POST" action="./php/update_password.php">
            <div class="mb-3">
                        <label for="nueva_password" class="form-label"><b>Nueva contraseña</b></label>
                        <input type="password" class="form-control" id="nueva_password" name="nueva_password" required>
                    </div>
            </div>
            <div class="modal-footer">
                <div class="d-flex justify-content-center">
                <button type="submit" class="btn btn-dark btn-personalizado mx-auto">Actualizar</button>
                </div>
            </div>
            </form>
        </div>
    ...
    <script>
        // Código JavaScript para mostrar el modal aquí
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-md-4 col-lg-4 mb-2 mb-md-3">
                <button class="btn btn-dark btn-custom d-flex flex-column justify-content-center align-items-center mr-2" onclick="window.location.href='./citasMenu.php'"><i class="bi bi-calendar"></i><span>Citas</span></button>
            </div>
            <div class="col-12 col-md-4 col-lg-4 mb-2 mb-md-3">
                <button class="btn btn-dark btn-custom d-flex flex-column justify-content-center align-items-center mr-2" onclick="window.location.href='./reportes.php'"><i class="bi bi-file-earmark-text"></i><span>Reportes</span></button>
            </div>
            <div class="col-12 col-md-4 col-lg-4 mb-2 mb-md-3">
            ...
            <div class="col-12 col-md-4 col-lg-4 mb-2 mb-md-3">
                <button class="btn btn-dark btn-custom d-flex flex-column justify-content-center align-items-center mr-2" onclick="window.location.href='./notas.php'"><i class="bi bi-sticky"></i><span>Notas</span></button>
            </div>
            <div class="col-12 col-md-4 col-lg-4 mb-2 mb-md-3">
                <button class="btn btn-dark btn-custom d-flex flex-column justify-content-center align-items-center mr-2" onclick="window.location.href='./medallas.php'"><i class="bi bi-award"></i><span>Medallas</span></button>
            </div>
