...
<head>
    ...
    <script src="../js/checkCitasSeparadas.js"></script>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-vino bg-maroon">
            ...
            <img src="./css/NavUPTex.png" alt="Logo" style="width: 200px; height: 50px;">
                ...
                <button id="mensajesBtn" class="btn btn-maroon mr-2 hover-effect" onclick="window.location.href='./mensajes.php'">
                ...
                <button id="regresarBtn" class="btn btn-vino mr-2 hover-effect1" onclick="window.location.href='./indexProfesor.php'">Regresar</button>
<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
    ...
    <div class="row justify-content-center mt-3">
            <?php
            // Si el profesor tiene nivel de acceso 2, mostrar los botones de citas canalizadas y citas por canalizar
            if ($result_nivel->num_rows > 0) {
                echo '
        <div class="col-12 col-md-4 col-lg-4 mb-2 mb-md-3">
        <button class="btn btn-dark btn-custom citasPropias d-flex flex-column justify-content-center align-items-center mr-2" onclick="window.location.href=\'./citasPropias.php\'"><i class="bi bi-calendar-check"></i><span>Citas académicas</span></button>
        </div>
        <div class="col-12 col-md-4 col-lg-4 mb-2 mb-md-3">
        <button class="btn btn-dark btn-custom citasCanalizar d-flex flex-column justify-content-center align-items-center mr-2" onclick="window.location.href=\'./citasCanalizar.php\'"><i class="bi bi-calendar"></i><span>Citas tutorías</span></button>
        </div>
        ';
            }
            // Si el profesor no tiene nivel de acceso 2, ocultar los botones de citas canalizadas y citas por canalizar
            else {
                echo '
        <div class="col-12 col-md-4 col-lg-4 mb-2 mb-md-3">
        <button class="btn btn-dark btn-custom citasPropias d-flex flex-column justify-content-center align-items-center mr-2" onclick="window.location.href=\'./citasPropias.php\'"><i class="bi bi-calendar-check"></i><span>Citas propias</span></button>
        </div>';
            }
            ?>
        </div>
