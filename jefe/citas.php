...
<body>
    ...
    <div class="container">
        <div class="d-flex justify-content-center">
            <h1><i class="bi bi-calendar-check-fill" style="color: #088C4F;"></i> <b>Citas</b></h1>
        </div>
...
<td>${cita.tipo_problema}</td>
                ...
                <td>
                <button class="btn btn-dark btn-personalizado btn-sm editar-cita" data-id="${cita.id_citas}" data-fecha="${cita.fecha}" data-hora="${cita.hora}" data-tipo="${cita.tipo_cita}" data-problema="${cita.tipo}"><i class="bi bi-pencil-fill"></i></button>
