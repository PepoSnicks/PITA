        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container">
                ...
                <div class="d-flex align-items-center">
                    <button id="mensajesBtn" class="btn btn-dark mr-2" onclick="window.location.href='./mensajes.php'">
                    ...
                    <button id="mensajesBtn" class="btn btn-dark mr-2" onclick="window.location.href='indexJefe.php'">Regresar</button>
