...
<body>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 col-md-4 col-lg-4 mb-2 mb-md-1">
            ...
            <div class="col-12 col-md-6 col-lg-4 mb-2 mb-md-1">
                <button class="btn btn-dark btn-custom d-flex flex-column justify-content-center align-items-center mr-2" onclick="window.location.href='./citasEliminadas.php'"><i class="bi bi-trash-fill"></i><span>Citas eliminadas</span></button>
            </div>
        </div>
    </div>
</body>
