                ...
                <div class="list-group">
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            // Obtener la ruta de la imagen de perfil del remitente desde la base de datos
                            $rutaImagen = $row['imagen_de_perfil'];
                            $imagenPerfilRemitente = $baseUrl . "/imagenes/default.jpg";
                    
                            // Verificar si la ruta de la imagen de perfil no está vacía
                            if (!empty($rutaImagen)) {
                                // Si hay una imagen de perfil personalizada, mostrarla
                                $imagenPerfilRemitente = $baseUrl . "/" . $rutaImagen;
                            }
                    
                            echo "<img src='{$imagenPerfilRemitente}' alt='Imagen perfil' class='mr-3' style='width: 40px; height: 40px; border-radius: 50%;'>";
                            echo "<div>";
...
function buscarProfesorPorNombre(nombre) {
    ...
    xhr.open("POST", "php/buscarProfesorPorNombreMensaje.php", true);
